...
public class Cycler : MonoBehaviour
{
    ...
    [SerializeField]
    private GameObject activeThruster;
    ...
    void Update()
    {
        activeHead = headList[headList.Count - headIndex];
        activeBody = bodyList[bodyList.Count - bodyIndex];
        activeThruster = thrusterList[thrusterList.Count - thrusterIndex];
    }
    ...
    {
        get { return activeHead; }
    }
    public GameObject ActiveBody
    {
        get { return activeBody; }
    }
    public GameObject ActiveThruster
    {
        get { return activeThruster; }
    }
